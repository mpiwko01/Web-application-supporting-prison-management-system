...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['prisonerId']) && !empty($_POST['prisonerId']) && isset($_POST['name']) && !empty($_POST['name']) && isset($_POST['surname']) && !empty($_POST['surname']) && isset($_POST['sex']) && !empty($_POST['sex']) && isset($_POST['birthDate']) && !empty($_POST['birthDate']) && isset($_POST['pesel']) && !empty($_POST['pesel'])&& isset($_POST['street']) && !empty($_POST['street'])&& isset($_POST['houseNumber']) && !empty($_POST['houseNumber'])&& isset($_POST['city']) && !empty($_POST['city']) && isset($_POST['zipCode']) && !empty($_POST['zipCode']) && isset($_POST['startDate']) && !empty($_POST['startDate']) && isset($_POST['endDate']) && !empty($_POST['endDate']) && isset($_POST['crime']) && !empty($_POST['crime'])) {
        ...
        $query_prisoners = "UPDATE `prisoners` SET `name` = '$name', `surname`='$surname', `sex`='$sex', `birth_date`='$birthDate', `street`='$street', `house_number`='$houseNumber', `city`='$city', `zip_code`='$zipCode', `pesel`='$pesel' WHERE `prisoner_id`='$prisonerId'";
